...
DATA_OUTPUT_PATH = "../data/pretest data.json" #OUTPUT LOCATION FOR THE DATA JSON FILE

PLAYLIST_NAME = "night lights" # SPECIFY PLAYLIST NAME HERE
...
def get_playlists():
    ...
    print(f"JSON saved to: {DATA_OUTPUT_PATH}")
